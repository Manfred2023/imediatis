...
<div class="form col-xxl">
                  <div class="card mb-4">
                    ...
                    ?>
                      ...
                      <form action="../../api/controller/contacts/update/" method="POST">
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">First Name </label>
                          <input type="text" class="form-control" id="basic-default-fullname"  name="firstname"  value="<?php $firstname?>"/>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Last Name</label>
                          <input type="text" class="form-control" id="basic-default-fullname"  name="lastname"  value="<?php $lastname?>"/>
                        </div>
                        <!-- <div class="mb-3">
